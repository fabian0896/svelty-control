...
const ConfirmModal = props => {
    const { className, open, onClose, type, onSave } = props
        ...
        <Modal className={clsx(className, classes.modal)} onClose={onClose} open={open}>
            ...
            <Paper className={classes.root}>
                <div className={classes[type]}>
                    <Typography color="inherit" variant="h3">Nuevo {type === "income" ? "ingreso" : "egreso"}</Typography>
                    <Typography color="inherit" variant="body1">Llena los datos para agregar un nuevo {type === "income" ? "ingreso" : "egreso"}</Typography>
                </div>
